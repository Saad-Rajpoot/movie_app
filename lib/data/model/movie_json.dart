...
MovieJson movieJsonFromJson(String str) => MovieJson.fromJson(json.decode(str));

String movieJsonToJson(MovieJson data) => json.encode(data.toJson());
  ...
  Map<String, dynamic> toJson() =>
      {
        ...
        "genre_ids": genreIds.isEmpty ? [] : List<dynamic>.from(
            genreIds.map((x) => x)),
        "id": id,
